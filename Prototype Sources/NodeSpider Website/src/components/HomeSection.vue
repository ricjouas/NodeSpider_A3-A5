        ...
        <v-col cols="10">
          <v-row align="center" justify="center">
            <v-col cols="12" md="6" xl="8">
              <h1 class="display-2 font-weight-bold mb-4">NodeSpider.</h1>
              <h2>Home of the Smart Parcel Box</h2>
              <h1 class="font-weight-light">
                Our incredible one-time collaboration<br />
                to produce the world's finest <br />
                All-In-One Smart Parcel Box system.
              </h1>
              <v-btn
                rounded
                outlined
              ...
              <div class="video d-flex align-center py-4">
                ...
                <p class="subheading ml-2 mb-0">Click to View our Product Presentation</p>
              </div>
            </v-col>
